...
const HomePage = () => {
  const [messages, setMessages] = useState<Message[]>([
    ...
    {
      id: 3,
      text: "What’s Chattrix all about?",
      time: "6:31 pm",
      isUser: true,
    },
    {
    ...
    {
      id: 5,
      text: "Sounds awesome! How do I join?",
      time: "6:33 pm",
      isUser: true,
    },
  ]);
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12 fade-up">
          ...
          <p className="text-gray-400 text-lg mb-8">
            Chattrix is your go-to place for seamless real-time conversations.
            Whether it's for teams, friends, or open communities — we've got you
            covered.
          </p>
        </div>
                ...
                >
                  <div
                    className={`w-8 h-8 rounded-full flex-shrink-0 ${
                      message.isUser ? "bg-pink-200/20" : "bg-purple-200/20"
                    }`}
                  >
                  ...
                  <div>
                    <div
                      className={`rounded-2xl px-4 py-2 ${
                        message.isUser ? "bg-pink-200/20" : "bg-gray-800/50"
                      }`}
                    >
            ...
            {[
              {
                ...
                desc: "Send and receive messages instantly with no delay.",
              },
              {
                title: "Community Focused",
                desc: "Built to foster conversations within teams and open groups.",
              },
              {
                title: "Secure & Scalable",
                desc: "Your data stays private and the app scales with your needs.",
              },
            ].map((feature, i) => (
        ...
        <div className="mb-16 text-center fade-up">
          ...
          <p className="text-gray-400 mb-8">
            Loved by devs, teams, and communities worldwide.
          </p>
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {[
              {
                name: "Aman",
                text: "Chattrix changed the way our dev team communicates. Super fast and clean UI!",
              },
              {
                name: "Sofia",
                text: "I started a public community on Chattrix — best decision ever!",
              },
            ].map((t, i) => (
        ...
        <div className="text-center fade-up">
          ...
          <p className="text-gray-400 mb-6">
            Join our growing community of developers and creators today.
          </p>
          <Link
            to="/login"
